...
%Vi får samma rötter, att skalärmultiplicera ger en ny linjärtberoende ekv.
...
hold on
plot([7,9,4,10,2],[9,2,9,10,9], "b*")
plot(xx,yy)

hold off

%X=6.4873, Y=5.9676, R=4.5788
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
while norm(t) > 10^-6
    disp(norm(t))
    t=(DF(x(1),x(2),x(3))'*DF(x(1),x(2),x(3)))\DF(x(1),x(2),x(3))'*F(x(1),x(2),x(3));
    x=x-t;
